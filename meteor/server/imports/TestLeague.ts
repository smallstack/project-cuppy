// import { IOC, User } from "@smallstack/core-common";
// import {
//     Competition, CompetitionRound, CompetitionRoundsService, CompetitionsService,
//     CompetitionTeam, CompetitionTeamsService
// } from "@smallstack/datalayer";
// import { TestDataGenerator } from "@smallstack/meteor-server";

// Meteor.startup(() => {
//     const competitionService: CompetitionsService = CompetitionsService.instance();
//     const testDataGenerator: TestDataGenerator = IOC.get<TestDataGenerator>("testDataGenerator");
